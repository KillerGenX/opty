        ...
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="hidden lg:block space-y-6">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-slate-900 dark:text-zinc-100 tracking-tight leading-[1.1]">
              Manajemen Opportunity, <br />
              <span className="font-[family-name:Georgia,serif] italic text-emerald-900 dark:text-emerald-500 font-normal">diotomatisasi</span> <br />
              oleh AI.
            </h1>

            <p className="text-lg text-slate-600 dark:text-zinc-400 max-w-md leading-relaxed">
              Platform cerdas untuk melacak Opportunity, memecah perhitungan TCV & MRC secara akurat, dan mengklasifikasikan produk tanpa repot.
            </p>

            <div className="grid grid-cols-3 gap-6 pt-6 mt-4 border-t border-slate-200/60 dark:border-zinc-800 max-w-md">
              <div>
                <p className="text-2xl font-light text-slate-900 dark:text-zinc-100">Real-Time</p>
                <p className="text-[10px] font-semibold text-slate-500 dark:text-zinc-500 mt-1 uppercase tracking-wider">Dashboard</p>
              </div>
              <div>
                <p className="text-2xl font-light text-slate-900 dark:text-zinc-100">Magic</p>
                <p className="text-[10px] font-semibold text-slate-500 dark:text-zinc-500 mt-1 uppercase tracking-wider">Auto-Fill AI</p>
              </div>
              <div>
                <p className="text-2xl font-light text-slate-900 dark:text-zinc-100">100%</p>
                <p className="text-[10px] font-semibold text-slate-500 dark:text-zinc-500 mt-1 uppercase tracking-wider">Visibilitas</p>
              </div>
            </div>
          </div>
